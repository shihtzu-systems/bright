...
func LoadCharacterCustomizationCategory(destiny *data.Content, redis tower.Redis, overwrite bool) {
	log.Infof("CharacterCustomizationCategory [%d]", len(destiny.CharacterCustomizationCategory.Values()))
	if !redis.Exists(data.CharacterCustomizationCategoryDefinitionName) {
		log.Infof("Loading %d CharacterCustomizationCategory", len(destiny.CharacterCustomizationCategory.Values()))
...
func GetCharacterCustomizationCategory(hash string, redis tower.Redis) (out data.CharacterCustomizationCategoryDefinition) {
