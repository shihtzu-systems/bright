...
func LoadUnlockExpressionMapping(destiny *data.Content, redis tower.Redis, overwrite bool) {
	log.Infof("UnlockExpressionMapping [%d]", len(destiny.UnlockExpressionMapping.Values()))
	if !redis.Exists(data.UnlockExpressionMappingDefinitionName) {
		log.Infof("Loading %d UnlockExpressionMapping", len(destiny.UnlockExpressionMapping.Values()))
...
func GetUnlockExpressionMapping(hash string, redis tower.Redis) (out data.UnlockExpressionMappingDefinition) {
